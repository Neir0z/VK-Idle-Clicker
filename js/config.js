/**
 * Глобальная конфигурация и баланс игры.
 * Dev-режим активируется через ?dev=true в URL.
 */
...
export const BALANCE = {
  baseClick: 1,
  basePerSecond: 0,
  offlineMultiplier: 0.5, // 50% от обычного дохода офлайн
  maxOfflineHours: 12,
...
/** Аналитика (заглушки под VK App Metrica / YM) */
